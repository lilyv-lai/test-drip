...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-start min-h-screen text-black">
      ...
      <section className="relative overflow-hidden w-full h-full py-24 sm:py-32 bg-[#EFEFEF]">
      {/* Full-bleed background image (behind everything) */}
      <div className="absolute inset-0 left-1/2 -translate-x-1/3 w-screen h-full -translate-y-1/3 -z-0">
        <img
          src="/images/coffeeflighthomepage.png"
          alt=""
          className="w-470 object-cover pointer-events-none"
        />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              <h2 className={`${lora.className} text-base/7 font-semibold text-[#677D50]`}>
                cà phê [kah-fey] • coffee
              </h2>
              <p className={`${lato.className} mt-2 text-4xl font-semibold text-pretty text-[#242831] sm:text-5xl`}>
                ABOUT US
              </p>
              ...
              <div className="mt-4 flex">
                <a
                  href="https://www.instagram.com/dripcaphe_espressobar/"
                  target="_blank"
                ...
                <a
                  href="https://www.yelp.com/biz/drip-c%C3%A0-ph%C3%AA-annandale"
                  target="_blank"
          ...
          {/* Right column (optional extra content / image / empty) */}
          <div className="lg:pt-4 lg:pl-8"></div>
        </div>
      </div>
      {/* <!-- Elfsight All-in-One Reviews | Untitled All-in-One Reviews --> */}
        <script src="https://static.elfsight.com/platform/platform.js" async></script>
